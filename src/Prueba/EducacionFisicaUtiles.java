...
import Utiles.ClasesUtiles.EducacionFisica.*;
...
public abstract class EducacionFisicaUtiles {
    ...
    public static double getTestCooperFormula(int distancia) {
        ...
        return entre(1500, distancia, 4000, true) ? (22.351 * ((double) distancia / (double) 1000)) - 11.288 : -1;
    }

    public static double getTestCooperTabla(int distancia) {
        if (entre(1500, distancia, 4000, true)) {

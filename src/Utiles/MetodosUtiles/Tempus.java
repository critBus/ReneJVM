...
/**
 * metodos para trabajar con datos relacionados con el paso del tiempo Version
 * 0.6
 *
 * @author Rene
 */
...
//     * @return 
//     */
//    public static String getFechaYHoraConSegundosSQL(java.sql.Date d){
//      return getFechaYHoraConSegundos(d);  
//    }
...
//    }
    ...
    public static int cantidadDeDiasEntreFechas(Date a, Date b) {
        return cantidadDeDiasEntreFechas(a.getDate(), a.getMonth(), a.getYear(), b.getDate(), b.getMonth(), b.getYear());
    }

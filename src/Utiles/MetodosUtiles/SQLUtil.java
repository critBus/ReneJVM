...
import Utiles.ClasesUtiles.BasesDeDatos.TipoDeClasificacionSQL;
import Utiles.ClasesUtiles.BasesDeDatos.TipoDeOrdenamientoSQL;
import Utiles.ClasesUtiles.BasesDeDatos.BasicoBD;

import Utiles.ClasesUtiles.Interfases.Funcionales.Creador2;
//import static Utiles.MetodosUtiles.MetodosUtiles.esArreglo;
//import static Utiles.MetodosUtiles.MetodosUtiles.esArregloString;
 ...
 * @author Rene
 */
public abstract class SQLUtil extends BasicoBD{
...
/**
 * // * (nombre,.. nombreColumna,TipoDeDatoSQL,capacidad#,isKeyPrimary)</br>
 * // * (nombre,.. nombreColumna,TipoDeDatoSQL,capacidad#)</br> asumo que no es
 * llave primaria // (nombre,.. nombreColumna,capacidad#) asumo que es VARCHAR
 * </br>
 * // (nombre,.. nombreColumna) asumo que es VARCHAR(255) </br>
 ...
 * // si el siguiente a TipoDeDatoSQL no es un # asumo que es VARCHAR(255)
 * </br>
 * // * @param nombreTabla // * @param nombre_tipos // * @return //
 */
//    public static String crearTabla(String nombreTabla, Object... nombre_tipos) {
//
//        Object[] a = nombre_tipos;
//
//        String sql = "";
//        TipoDeDatoSQL tipoAnterior = null;
//        TipoDeDatoSQL tipo = null;
//        int pos = 0;
//        boolean hayLlavePrimaria=false;
...
//                    tipo = (TipoDeDatoSQL) i;
//                }
//                if (tipo != null) {
//                    sql += strg(" ", ((TipoDeDatoSQL) i).getValor());
//                    tipoAnterior = tipo;
//                } else if (esInt(i)) {
//
//                    tipo = TipoDeDatoSQL.VARCHAR;
...
//
//        }
//        if(!hayLlavePrimaria&&!sql.contains(" id ")){

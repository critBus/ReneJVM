 ...
 * @author Rene
 */
public class BDConexion extends BasicoBD{
...
//    }
    ...
    public BDConexion select_Columna_Recorrer(String nombreTabla, String columna, Utilizar2Exception<Object, Integer> recorrer) throws Exception {
        Object[][] O = select(nombreTabla, columna);
    ...
    public BDResultadoInsertar insertar_ConIdAutomatico(String nombreTabla, String id, Object... a) throws Exception {
        // System.out.println("se confunde total");
        Object O=getGestorDeConexionImple()._execute(SQLUtil.insertar_idAutomatico(nombreTabla, id, a));
    ...
    private class GestionadorDeConexion extends GestorDeConexionImple {
        ...
        public Object _execute(String sql) throws Exception {
            ...
            if (SQLUtil.esSelect(sql)) {
                ...
                //System.out.println("clase ins=" + dc.instruccion.getClass());

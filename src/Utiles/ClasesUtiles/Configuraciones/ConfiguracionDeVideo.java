...
//    }
    public ConfiguracionDeVideo(boolean renombrarCarpetasInternas //1
            , boolean incluirTemporada, //2
            String[] antesIngnorar,//3
            String[] despuesIngnorar, //4
            String[][] rodearIgnorar,//5
            String[] union,//6
            String[] saltarAlPrincipio,//7
            String[] detenciones,//8
            int nivelesCarpetasInternas,//9
            int cantidadAMover,//10
            int cantidadASaltarO,//11
            int[] cantidadAntesIngnorarO,//12
            int[] cantidadDespuesIngnorarO,//13
            int[] formato, //14
            String separacionString[],//15
            String saltarHastaDespuesDe[],//16
            String identificadoresTemporadas[], String identificadoresCapitulo[],
...
//        return new ConfiguracionDeVideo(getRenombrarCarpetasInternasDefault(), Videos.saltarAntes, Videos.saltarDespues, Videos.rodearIgnorar, Videos.union, Videos.saltarAlPrincipio, Videos.detenciones, getNivelesCarpetasInternasDefault(), getCantidadAMoverDefault(), getCantidadASaltarDefault(), getCantidadAntesIngnorarODefault(), getCantidadDespuesIngnorarODefault(), new int[]{1, 1, 1, 1}, Archivo.separacionString, Archivo.saltarHastaDespuesDe, Videos.identificadoresTemporadas, Videos.identificadoresCapitulo, Videos.identificadoresCantidadCapituloTemporada, MetodosUtiles.terminacionesNumericas, Videos.noSaltarAlPrincipio, Videos.detencionesAbsolutas);
        return new ConfiguracionDeVideo(getRenombrarCarpetasInternasDefault(),//1
                getIncluirTemporasDefault(),//2
                Videos.saltarAntes, //3
                Videos.saltarDespues, //4
                Videos.rodearIgnorar, //5
                Videos.union,//6
                Videos.saltarAlPrincipio,//7
                Videos.detenciones, //8
                getNivelesCarpetasInternasDefault(), //9
                getCantidadAMoverDefault(),//10
                getCantidadASaltarDefault(), //11
                getCantidadAntesIngnorarODefault(),//12
                getCantidadDespuesIngnorarODefault(),//13
                tipoFormato.AUTOMATICO.getFormatoPredeterminado(), //14
                Archivo.separacionString,//15
                Archivo.saltarHastaDespuesDe,//16 
                Videos.identificadoresTemporadas, Videos.identificadoresCapitulo, Videos.identificadoresCantidadCapituloTemporada, MetodosUtiles.terminacionesNumericas, Videos.noSaltarAlPrincipio, Videos.detencionesAbsolutas, Paquete.invalidosPaquete, Videos.saltarAntesNumero, Videos.saltarDespuesNumero);
    }
